  ...
  const day1Tracks = [
    {
      ...
      sessions: [
/* Day 1*/ 
        { start: '10:00', end: '13:00', topic: 'Registration', speaker: '', isBreak: true },
...
/* Session 1*/
        { start: '13:10', end: '13:15', topic: 'Session 1: Primary Total Hip Arthroplasty', speaker: 'Moderator: Dr. David Liu', isSession: true },
        { start: '13:10', end: '13:15', topic: 'Is modern THA as good as it will ever be?', speaker: '' },
        { start: '13:15', end: '13:20', topic: 'Leveraging Marginal Gains to elevate outcomes in THA', speaker: 'Dr. Ryan Nunley?' },
        ...
        { start: '14:55', end: '15:05', topic: 'Wound Complication avoidance in Joint Replacement', speaker: 'Faculty Name' },
        { start: '15:05', end: '15:20', topic: 'Coffee Break', speaker: '', isBreak: true },
/* Session 2*/
        { start: '15:20', end: '15:25', topic: 'Session 2: Technology in Primary THA', speaker: 'Moderator: Dr. Phonthakorn Panichkul', isSession: true },
        { start: '15:20', end: '15:25', topic: 'Technology in THA: what\'s useful, what\'s marketing hype?', speaker: 'Faculty Name'},
        { start: '15:25', end: '15:30', topic: 'Spino-pelvic analysis for every patient?', speaker: 'Faculty Name' },
        ...
        { start: '16:05', end: '16:10', topic: 'Why are we still using mallets?', speaker: 'Dr. Pang Hee Nee ? Alton? Nunley?' },       
        ...
        { start: '16:30', end: '16:40', topic: 'Case Presentation: Wound closure in complex patients', speaker: 'Faculty Name' },
        { start: '16:40', end: '16:45', topic: '5 things in 5 minutes: improving wound closure efficiency in Joint Replacement', speaker: 'Faculty name' },
/* Session 3*/        
        { start: '16:50', end: '16:55', topic: 'Session 3: Revision Hip Arthroplasty', speaker: 'Moderator: Dr. Pil Whan Yoon', isSession: true },
        { start: '16:50', end: '16:55', topic: 'Reasons for Revision of Primary THA in Asia Pacific', speaker: 'Prof. Richard Carey-Smith?' },
        ...
        { start: '17:45', end: '17:50', topic: 'Day 1 Close', speaker: 'Dr. David Liu' },
      ]
    }
  ];
...
/* Day 2*/
/* Session 4*/  
        { start: '08:30', end: '08:40', topic: 'Session 4: Primary Total Knee Arthroplasty', speaker: 'Moderator:', isSession: true },
        { start: '08:30', end: '08:40', topic: 'Optimizing every layer – the impact of tissue handling and hemostasis on TKA success', speaker: 'Moderator:'},
        { start: '08:40', end: '08:50', topic: 'Beyond CPAK – understanding bone and soft tissue phenotypes', speaker: 'Prof. Michael Hirschmann?' },
        ...
        { start: '10:20', end: '10:35', topic: 'Coffee Break', speaker: '', isBreak: true },
/* Session 5*/
        { start: '10:35', end: '10:40', topic: 'Session 5: Technology in primary TKA', speaker: 'Moderator:', isSession: true },
        { start: '10:35', end: '10:40', topic: 'Is technology helping to solve a problem?', speaker: '' },
        { start: '10:40', end: '11:00', topic: 'Debate: Robotic Assistance will be ubiquitous in TKA in 5 years\n• Absolutely!\n• Manual instruments and less costly tech still has a place!', speaker: 'Faculty Name' },
        { start: '11:00', end: '11:30', topic: 'Case Presentations: Robotic TKA\n• Kinematic Alignment with Robotic Assistance\n• Femur First Functional Alignment\n• iKA with Robotic Assistance', speaker: 'Faculty Name' },
/* Session 6*/      
        { start: '11:30', end: '11:40', topic: 'Session 6: Unicompartmental Knee Arthroplasty', speaker: 'Moderator:', isSession: true },
        { start: '11:30', end: '11:40', topic: 'How to optimize success with UKA', speaker: 'Faculty name' },
        ...
        { start: '11:55', end: '12:05', topic: 'HTO vs UKA – which procedure is right for which patient?', speaker: 'Dr. Murakami?' },
        { start: '12:05', end: '12:25', topic: 'Case Presentations\n• Robotic Assisted UKA\n• High Tibial Osteotomy', speaker: '' },
        { start: '12:25', end: '12:30', topic: 'Fixed or Mobile Bearing in UKA – what I use', speaker: 'Faculty name' },
        { start: '12:30', end: '13:30', topic: 'Lunch', speaker: '', isBreak: true },
        { start: '13:30', end: '15:30', topic: 'Breakout Rotations', speaker: '' },
        { start: '15:30', end: '15:45', topic: 'Coffee Break', speaker: '', isBreak: true },
/* Session 7*/      
        { start: '15:45', end: '16:15', topic: 'Session 7: Patient Centric Considerations in Joint Arthroplasty', speaker: 'Moderator:', isSession: true },
...
/* Day 3*/
/* Session 8*/  
        { start: '08:30', end: '08:40', topic: 'Session 8 Revision Knee Arthroplasty', speaker: 'Session Chair Prof. Richard Carey-Smith', isSession: true },
        ...
        { start: '10:15', end: '10:30', topic: 'Coffee Break', speaker: '', isBreak: true },
        { start: '10:30', end: '10:40', topic: 'Surgery / Wound Closure Topics TBC', speaker: '' },
        { start: '10:40', end: '10:50', topic: 'Surgery / Wound Closure Topics TBC', speaker: '' },
