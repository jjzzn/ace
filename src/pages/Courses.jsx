...
const Courses = () => {
  ...
  const courses = {
    simplify: {
      ...
      agenda: {
        monday: {
          ...
          time: '6:30pm -9:00pm',
          sessions: [
            { time: '18:30', duration: '5mins', title: 'Welcome and Course Objectives', speaker: 'xxxx(DPS)' },
            { time: '18:35', duration: '5mins', title: 'ATTUNE Revision System Design Overview', speaker: 'DPS or Faculty' },
            { time: '18:40', duration: '5mins', title: 'RECLAIM Revision Stems Design Overview', speaker: 'DPS or Faculty' },
            { time: '18:45', duration: '10mins', title: 'Implant Removal techniques in rTKA', speaker: '' },
            { time: '19:00', duration: '10mins', title: 'Implant Removal in rTHA', speaker: '' },
            { time: '19:10', duration: '10mins', title: 'Watson Extraction System Surgical Video', speaker: '' },
            { time: '19:20', duration: '60mins', title: 'Dinner', speaker: '' },
            { time: '20:20', duration: '15mins', title: 'Exposure in Revision TKA\n• Tibial Tubercle Osteotomy\n• Rectus Snip', speaker: '' },
            { time: '20:35', duration: '15mins', title: 'Managing Complications in Revision THA\n• Femoral Fracture\n• Extended Trochanteric Osteotomy', speaker: '' },
            { time: '20:50', duration: '10mins', title: 'Close Day 1, Day 2 logistics and transfers information', speaker: 'xxxxx(DPS)' }
          ]
        },
        tuesday: {
          ...
          time: '9:00am -4:00pm',
          sessions: [
            { time: '9:00', duration: '60mins', title: 'Welcome and Objectives', speaker: '(DPS)', isHeader: true },
            { time: '9:00', duration: '60mins', title: 'Group A Surgical Demonstrations:\n• Reclaim MB Surgical technique demonstration\n• Reclaim Modular technique demonstration', colSpan: 1, speaker: '' },
            { time: '9:00', duration: '60mins', title: 'Group B Surgical Demonstrations:\n• ATTUNE Revision RP & Sleeves', colSpan: 1, speaker: '' },
            { time: '10:05', duration: '15mins', title: 'Morning Tea Break', speaker: '', isBreak: true },
            { time: '10:20', duration: '100mins', title: 'Hands-on Skills Lab Group A: Revision Hip\n• Exposure & Extensile Releases\n• Implant Removal – Watson Extraction System\n• Femoral Preparation – Reclaim MB or Reclaim Modular\n• Trial and Implantation', colSpan: 1, speaker: 'All delegates and faculty' },
            { time: '10:20', duration: '100mins', title: 'Hands-on Skills Lab Group B: Revision Knee\n• Exposure & Extensile Releases\n• Implant Removal\n• Tibial Preparation & defect management\n• Femoral Preparation & defect management\n• Trial and Implant Assembly', colSpan: 1, speaker: 'All delegates and faculty' },
            { time: '12:00', duration: '60mins', title: 'Lunch Break', speaker: '', isBreak: true },
            { time: '13:00', duration: '60mins', title: 'Group B Surgical Demonstrations:\n• ATTUNE Revision RP & Sleeves', colSpan: 1, speaker: '' },
            { time: '13:00', duration: '60mins', title: 'Rotation A Surgical Demonstrations:\n• Reclaim MB Surgical technique demonstration\n• Reclaim Modular technique demonstration', colSpan: 1, speaker: '' },
            { time: '14:00', duration: '100mins', title: 'Hands-on Skills Lab Rotation B: Revision Knee\n• Exposure & Extensile Releases\n• Implant Removal\n• Tibial Preparation & defect management\n• Femoral Preparation & defect management\n• Trial and Implant Assembly', colSpan: 1, speaker: 'All delegates and faculty' },
            { time: '14:00', duration: '100mins', title: 'Hands-on Skills Lab Rotation A: Revision Hip\n• Exposure & Extensile Releases\n• Implant Removal – Watson Extraction System\n• Femoral Preparation – Reclaim MB or Reclaim Modular\n• Trial and Implantation', colSpan: 1, speaker: 'All delegates and faculty' },
            { time: '15:40', duration: '20mins', title: 'Close and Certificates', speaker: 'Tom Carey (DPS) and faculty' }
          ]
        }
      },
      faculty: [
    ...
    anterior: {
      ...
      dates: 'May 17th & 18th, 2026',
      schedule: [
        'Sunday 17th Dinner 7pm – 10pm',
        'Monday 18th 8:30am – 4pm'
      ],
      ...
      agenda: {
        monday: {
          ...
          time: '9am – 3:30pm',
          sessions: [
            { time: '9:00', duration: '5mins', title: 'Welcome and Objectives', speaker: 'Tom Carey (DPS)', isHeader: true },
            { time: '09:05', duration: '30mins', title: 'Surgical Technique Presentations –Direct Anterior Approach (DAA) using standard OR table\n• Patient positioning and exposure\n• Osteotomy\n• Acetabular Preparation\n• Femoral Preparation\n• Trial and Implantation', speaker: 'Dr. Phonthakorn Panichkul' },
            { time: '09:35', duration: '10mins', title: 'Direct Anterior Approach: reducing over the learning curve', speaker: 'Dr. Tim Alton' },
            { time: '09:45', duration: '20mins', title: 'Technology in DAA THA – Fluoroscopic Navigation and Automated Impaction', speaker: 'Dr. Samuel Duff' },
            { time: '10:05', duration: '15mins', title: 'Morning Tea', speaker: '', isBreak: true },
            { time: '10:20', duration: '120mins', title: 'Hands-on Skills Lab Rotation 1: Direct Anterior Approach\n• Patient Positioning & Exposure\n• Femoral Head Osteotomy\n• Acetabular Preparation\n• Femoral Preparation\n• Trial and Implantation', speaker: 'All delegates and faculty' },
            { time: '12:20', duration: '60mins', title: 'Lunch Break', speaker: '', isBreak: true },
            { time: '13:20', duration: '120mins', title: 'Hands-on Skills Lab Rotation 2: Direct Anterior Approach\n• Patient Positioning & Exposure\n• Femoral Head Osteotomy\n• Acetabular Preparation\n• Femoral Preparation\n• Trial and Implantation', speaker: 'All delegates and faculty' },
            { time: '15:20', duration: '10mins', title: 'Close and Certificates', speaker: 'Tom Carey (DPS) and faculty' }
          ]
        }
      },
      faculty: [
    ...
    masters: {
      ...
      dates: 'May 17th & 18th, 2026',
      schedule: [
        'Sunday 17th Dinner 6:30pm – 9:30pm',
        'Monday 18th 8:30am – 4pm'
      ],
      location: 'DePuy Synthes Asia Pacific Learning Center',
      city: 'Bangkok, Thailand',
      ...
      agenda: {
        monday: {
          ...
          time: '6:00pm -9:30pm',
          sessions: [
            { time: '18:00', duration: '5mins', title: 'Welcome and Course Objectives', speaker: '(DPS)', isHeader: true },
            { time: '18:05', duration: '10mins', title: 'TKA vs UKA – patient selection, patient satisfaction', speaker: '' },
            { time: '18:15', duration: '15mins', title: 'ATTUNE & MS Insert – The Kinematic Knee Implant', speaker: '' },
            { time: '18:30', duration: '10mins', title: 'VELYS RAS TKA System Overview', speaker: '' },
            { time: '19:00', duration: '10mins', title: 'Why I choose Inverse Kinematic Alignment (iKA)', speaker: '' },
            { time: '19:10', duration: '10mins', title: 'Why I choose Kinematic Alignment (KA)', speaker: '' },
            { time: '19:20', duration: '10mins', title: 'Why I choose Functional Alignment (FA)', speaker: '' },
            { time: '19:23', duration: '60mins', title: 'Dinner', speaker: '', isBreak: true },
            { time: '20:30', duration: '15mins', title: 'Sigma Partial Design & Survivorship', speaker: '' },
            { time: '20:45', duration: '10mins', title: 'VELYS RAS UKA System Overview', speaker: '' },
            { time: '21:15', duration: '10mins', title: 'UKA Exposure and Wound Closure', speaker: '' },
            { time: '21:25', duration: '5mins', title: 'Close Day 1, Day 2 logistics and transfers information', speaker: '(DPS)' }
          ]
        },
        tuesday: {
          title: 'Monday 18th May',
          ...
          time: '9am – 4pm',
          sessions: [
            { time: '9:00', duration: '5mins', title: 'Welcome and Objectives', speaker: '(DPS)', isHeader: true },
            { time: '', duration: '', title: 'Session 1: Kinematic Restoration', speaker: '', isHeader: true },
            { time: '9:05', duration: '15mins', title: 'Demonstration: Landmarking and Planning for Kinematic Alignment with VELYS Robotic-Assisted Solution', speaker: '' },
            { time: '9:20', duration: '15mins', title: 'Demonstration: Landmarking and Planning for Inverse Kinematic Alignment with VELYS Robotic-Assisted Solution', speaker: '' },
            { time: '9:35', duration: '120mins', title: 'Hands-on Skills Lab : Kinematic Restoration\n• iKA, KA or FA workflow\n• Surgical Efficiency Tips & Tricks from faculty', speaker: 'All delegates and faculty' },
            { time: '11:35', duration: '45mins', title: 'Lunch Break', speaker: '', isBreak: true },
            { time: '', duration: '', title: 'Session 2: UKA with VELYS RAS', speaker: '', isHeader: true },
            { time: '12:20', duration: '15mins', title: 'Demonstration: Landmarking and Planning for UKA with VELYS Robotic-Assisted Solution', speaker: '' },
            { time: '12:35', duration: '120mins', title: 'Hands-on Skills Lab: UKA with VELYS RAS\n• Landmarking / registration process\n• Planning & Implant Sizing tips and tricks\n• Resections\n• Surgical Efficiencies', speaker: 'All delegates and faculty' },
            { time: '14:35', duration: '', title: '', speaker: '' },
            { time: '15:50', duration: '10mins', title: 'Close and Certificates', speaker: '(DPS) and faculty' }
          ]
        }
      },
      faculty: [
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-12">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="bg-gray-300 rounded-lg overflow-hidden aspect-[3/4]">
              <img 
                src="https://in2it-service.com/ace/knee.png" 
          ...
          <div className="md:col-span-2">
            ...
            <div className="text-gray-700 mb-6 leading-relaxed space-y-4">
              {activeCourse.description.split('\n\n').map((paragraph, idx) => {
                if (idx === 0) {
                  // First paragraph with bold course name
            ...
            {activeCourse.hasAgenda && (
              <div className="mt-8">
                ...
                {activeCourse.faculty && (
                  <div className="mt-8">
                    <h3 className="text-xl font-bold text-gray-900 mb-4 text-center">DISTINGUISHED FACULTY</h3>
